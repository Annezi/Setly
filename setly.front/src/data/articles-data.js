...
export const ARTICLES_LIST = [
  ...
  { id: 4, slug: 'esli-vy-ne-lyubite-planirovat', imageSrc: '/img/main/post4.png', imageAlt: 'Подготовка к поездке', title: 'Если вы не любите планировать', description: 'Покажем, как создать чек-план за 3 минуты, не обязательно заполнять с нуля', readTime: '5 минут' },
  { id: 5, slug: 'zachem-brat-raspechatannye-dokumenty', imageSrc: '/img/main/post5.png', imageAlt: 'Распечатанные документы', title: 'Зачем брать распечатанные документы', description: 'Даже если есть копии на почте. Покажем, как компактно хранить', readTime: '5 минут' },
  { id: 6, slug: '5-universalnykh-veschey-dlya-kazhdoy-poezdki', imageSrc: '/img/main/post6.png', imageAlt: '5 универсальных вещей', title: '5 универсальных вещей для каждой поездки', description: 'Они спасли многих в 90% поездок — от Тбилиси до Токио', readTime: '5 минут' },
];
